...
while (opcoes < 5):
  ...
  if opcoes==1:
      ...
      casa = float(input())
      print("Quanto você gastou com saúde este mês (ex: dentista, médico, plano de saúde)?")
      saude = float(input())
      ...
      if opcoes==2:
          ...
          while (opcoes < 9):
              ...
              print("1: Mês ; 2: Renda ; 3: Lazer ; 4: Alimentação ; 5: Casa ; 6: Saúde ; 7: Transporte ; 8: Voltar ;")
              ...
              if escolha == 1:
                  ...
                  gasto[2] = float(input("Quanto você gastou com lazer este mês?"))
              elif escolha == 4:
                  gasto[3] = float(input("Quanto você gastou com alimentação este mês?"))
              elif escolha == 5:
                  gasto[4] = float(input("Quanto você gastou com sua casa este mês (ex: aluguel, internet, luz e telefone)?"))
              elif escolha == 6:
                  gasto[5] = float(input("Quanto você gastou com saúde este mês (ex: dentista, médico, plano de saúde)?"))
              elif escolha == 7:
                  gasto[6] = float(input("Quanto você gastou com transporte este mês (ex: combustível, metrô/ônibus)?"))
              elif escolha == 8:
                  print("Selecione um dos itens abaixo:")
                  ...
                  if opcoes==3:
                      ...
                      if gasto[1]-gasto[2]-gasto[3]-gasto[4]-gasto[5]-gasto[6] < 0:
                          print("Aff.. O saldo deste mês foi negativo, o valor foi de: ",gasto[1]-gasto[2]-gasto[3]-gasto[4]-gasto[5]-gasto[6])
                      else:
                          print("Que bom!!, o saldo deste mês foi positivo, o valor foi de: ",gasto[1]-gasto[2]-gasto[3]-gasto[4]-gasto[5]-gasto[6])
                  if opcoes==4:
                      del gasto
          ...
          if opcoes==2:
              ...
              while (opcoes < 9):
                  ...
                  if escolha == 1:
                      ...
                      gasto[6] = float(input("Quanto você gastou com transporte este mês (ex: combustível, metro/ônibus)?"))
                  elif escolha == 8:
                      print("Selecione um dos itens abaixo:")
                      print("3: Consultar ; 4: Excluir ; 5: Sair ;")
                      opcoes = int(input("Qual voce deseja acessar?"))
